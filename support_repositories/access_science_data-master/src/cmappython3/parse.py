"""
Original: Generic parse method to parse either a .gct or a .gctx. 
UPdated: removed support for gct

Takes in a file path corresponding to either a .gct or .gctx, 
    and parses to a GCToo instance accordingly.

Original Note (now deprecated): Supports GCT1.2, GCT1.3, and GCTX1.0 files. 
Updated Note: only supports gctx files

"""
import logging
from cmappython3 import setup_GCToo_logger as setup_logger
# import cmapPy.pandasGEXpress.setup_GCToo_logger as setup_logger
from cmappython3 import parse_gctx
...
def parse(file_path, convert_neg_666=True, rid=None, cid=None, ridx=None, cidx=None,
    ...
    if file_path.endswith(".gctx"):
        ...
        err_msg = "File to parse must be .gctx!"
        logger.error(err_msg)
        raise Exception(err_msg)
